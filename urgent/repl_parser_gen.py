...
(lexicals, run_lexer) = lexer(r(COMMENT='//[^\\n\\r]*|#[^\\n\\r]*'), r(FLOAT='[-+]?[0-9]+\\.\\d+([eE][-+]?\\d+)?|[-+]?[0-9]+[eE][-+]?\\d+'), r(INT='[-+]?\\d+'), r(UPPER="[A-Z][a-zA-Z0-9_\\u4e00-\\u9fa5]*'?"), r(LOWER="[a-z_\\u4e00-\\u9fa5][a-zA-Z0-9_\\u4e00-\\u9fa5]*'?"), r(STRING='"([^\\\\"]+|\\\\.)*?"'), r(SPECIAL='\\-\\>|\\=\\>|\\=|\\=\\='), r(OP='[\\+\\-\\*\\/\\@\\~\\%\\>\\<][\\+\\-\\*\\/\\@\\~\\%\\>\\<\\:\\|\\=\\^]*'), r(SOP='\\|[\\+\\-\\*\\/\\@\\~\\%\\>\\<\\:\\|\\=\\^]+'), r(W='\\s+'), l['`'], l['^'], l[']'], l['['], l['?'], l['::'], l['.'], l[','], l[')'], l['('], ignores=['W', 'COMMENT'], reserved_map=ImmutableMap.from_dict({'?': 'quote ?', 'else': 'quote else', 'match': 'quote match', 'let': 'quote let', 'def': 'quote def', '=': 'quote =', ',': 'quote ,', 'rec': 'quote rec', 'do': 'quote do', 'open': 'quote open', 'import': 'quote import', 'infixl': 'quote infixl', 'infixr': 'quote infixr', '.': 'quote .', '_': 'quote _', '(': 'quote (', ')': 'quote )', '->': 'quote ->', 'or': 'quote or', 'and': 'quote and', 'in': 'quote in', '=>': 'quote =>', '^': 'quote ^', '::': 'quote ::', '==': 'quote ==', '`': 'quote `', '[': 'quote [', ']': 'quote ]', 'True': 'quote True', 'False': 'quote False', 'extern': 'quote extern'}), numbering={'BOF': 0, 'EOF': 1, 'quote ?': 2, 'quote else': 3, 'quote match': 4, 'quote let': 5, 'quote def': 6, 'quote =': 7, 'quote ,': 8, 'quote rec': 9, 'quote do': 10, 'quote open': 11, 'quote import': 12, 'quote infixl': 13, 'quote infixr': 14, 'quote .': 15, 'quote _': 16, 'quote (': 17, 'quote )': 18, 'quote ->': 19, 'quote or': 20, 'quote and': 21, 'quote in': 22, 'quote =>': 23, 'quote ^': 24, 'quote ::': 25, 'quote ==': 26, 'quote `': 27, 'quote [': 28, 'quote ]': 29, 'quote True': 30, 'quote False': 31, 'quote extern': 32, 'COMMENT': 33, 'FLOAT': 34, 'INT': 35, 'UPPER': 36, 'LOWER': 37, 'STRING': 38, 'SPECIAL': 39, 'OP': 40, 'SOP': 41, 'W': 42})
        ...
        if lcl_0:
            ...
            if lcl_1:
                ...
                if (lcl_3 == 27):
                    ...
                    lcl_4 = (_off_1, 'atom lookahead failed')
        ...
        if lcl_0:
            ...
            if (lcl_2 == 9):
                ...
                if lcl_3:
                    ...
                    lcl_5 = lcl_5.idint
                    if (lcl_5 == 15):
                        lcl_6 = parse_interactive__expr(prim__state, prim__tokens)
                        _slot_0_check = lcl_6
                        lcl_6 = _slot_0_check[0]
                        lcl_6 = (lcl_6 is False)
                        if lcl_6:
                        ...
                        lcl_6 = parse_stmt(prim__state, prim__tokens)
                        _slot_0_check = lcl_6
                        lcl_6 = _slot_0_check[0]
                        lcl_6 = (lcl_6 is False)
                        if lcl_6:
                    ...
                    lcl_4 = (_off_1, 'interactive got EOF')
                    lcl_4 = prim__cons(lcl_4, prim__nil)
                    lcl_4 = lcl_4
                    lcl_4 = (False, lcl_4)
                    lcl_3 = lcl_4
