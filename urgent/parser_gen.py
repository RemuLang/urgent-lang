...
(lexicals, run_lexer) = lexer(r(COMMENT='//[^\\n\\r]*|#[^\\n\\r]*'), r(FLOAT='[-+]?[0-9]+\\.\\d+([eE][-+]?\\d+)?|[-+]?[0-9]+[eE][-+]?\\d+'), r(INT='[-+]?\\d+'), r(UPPER="[A-Z][a-zA-Z0-9_\\u4e00-\\u9fa5]*'?"), r(LOWER="[a-z_\\u4e00-\\u9fa5][a-zA-Z0-9_\\u4e00-\\u9fa5]*'?"), r(STRING='"([^\\\\"]+|\\\\.)*?"'), r(SPECIAL='\\-\\>|\\=\\>|\\=|\\=\\='), r(OP='[\\+\\-\\*\\/\\@\\~\\%\\>\\<][\\+\\-\\*\\/\\@\\~\\%\\>\\<\\:\\|\\=\\^]*'), r(SOP='\\|[\\+\\-\\*\\/\\@\\~\\%\\>\\<\\:\\|\\=\\^]+'), r(W='\\s+'), l['^'], l[']'], l['['], l['?'], l['::'], l['.'], l[','], l[')'], l['('], ignores=['W', 'COMMENT'], reserved_map=ImmutableMap.from_dict({'module': 'quote module', 'let': 'quote let', 'def': 'quote def', '=': 'quote =', 'and': 'quote and', 'rec': 'quote rec', 'do': 'quote do', 'open': 'quote open', 'import': 'quote import', 'infixl': 'quote infixl', 'infixr': 'quote infixr', '.': 'quote .', '_': 'quote _', ',': 'quote ,', '(': 'quote (', ')': 'quote )', '?': 'quote ?', 'else': 'quote else', 'match': 'quote match', '->': 'quote ->', 'in': 'quote in', '=>': 'quote =>', '^': 'quote ^', '::': 'quote ::', 'or': 'quote or', '==': 'quote ==', '[': 'quote [', ']': 'quote ]', 'True': 'quote True', 'False': 'quote False', 'extern': 'quote extern'}), numbering={'BOF': 0, 'EOF': 1, 'quote module': 2, 'quote let': 3, 'quote def': 4, 'quote =': 5, 'quote and': 6, 'quote rec': 7, 'quote do': 8, 'quote open': 9, 'quote import': 10, 'quote infixl': 11, 'quote infixr': 12, 'quote .': 13, 'quote _': 14, 'quote ,': 15, 'quote (': 16, 'quote )': 17, 'quote ?': 18, 'quote else': 19, 'quote match': 20, 'quote ->': 21, 'quote in': 22, 'quote =>': 23, 'quote ^': 24, 'quote ::': 25, 'quote or': 26, 'quote ==': 27, 'quote [': 28, 'quote ]': 29, 'quote True': 30, 'quote False': 31, 'quote extern': 32, 'COMMENT': 33, 'FLOAT': 34, 'INT': 35, 'UPPER': 36, 'LOWER': 37, 'STRING': 38, 'SPECIAL': 39, 'OP': 40, 'SOP': 41, 'W': 42})



def mk_parser(Module, Do, Open, Cons, Let, Infix, Fun, Import, If, Match, Bin, Call, List, Tuple, Lit, Field, Coerce, Extern, Var, In, DQString):
    ...
    def parse_START(prim__state, prim__tokens):
        ...
        if lcl_0:
            ...
            if lcl_1:
                ...
                lcl_2 = parse_module(prim__state, prim__tokens)
                _slot_2_check = lcl_2
        ...
        if lcl_0:
            ...
            if lcl_1:
                ...
                if (lcl_3 == 21):
                    ...
                    lcl_4 = _py_local_t
                    _slot_1 = lcl_4
                    lcl_4 = parse_bin(prim__state, prim__tokens)
                    _slot_2_check = lcl_4
